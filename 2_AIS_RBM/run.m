...
% this is the main procedure for AIS algorithm
load data/test.mat;
numruns=200;
beta=0:1/10000:1;

load data/h10.mat;
[logZZ_h10,logZZ_h10_up,logZZ_h10_down]=RBM_AIS(parameter_W,parameter_a,parameter_b,numruns,beta,testbatchdata);
...
load data/h20.mat;
[logZZ_h20,logZZ_h20_up,logZZ_h20_down]=RBM_AIS(parameter_W,parameter_a,parameter_b,numruns,beta,testbatchdata);
...
load data/h100.mat;
[logZZ_h100,logZZ_h100_up,logZZ_h100_down]=RBM_AIS(parameter_W,parameter_a,parameter_b,numruns,beta,testbatchdata);
...
load data/h500.mat;
[logZZ_h500,logZZ_h500_up,logZZ_h500_down]=RBM_AIS(parameter_W,parameter_a,parameter_b,numruns,beta,testbatchdata);
